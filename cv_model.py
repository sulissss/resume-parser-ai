...
class PersonalInformation(BaseModel):
    ...
    first_name: str = Field(None, description="The individual's first name.")
    last_name: str = Field(None, description="The individual's last name.")
    full_name: str = Field(None, description="The individual's full name.")
    date_of_birth: str = Field(None, description="The individual's date of birth (YYYY-MM-DD).")
    gender: str = Field(None, description="The individual's gender.")
    nationality: str = Field(None, description="The individual's nationality.")
    phone_number: str = Field(None, description="The individual's primary contact number.")
    email_address: str = Field(None, description="The individual's email address.")
    address: str = Field(None, description="The individual's physical home address.")
    city: str = Field(None, description="City where the individual resides.")
    state: Optional[str] = Field(None, description="State where the individual resides (optional).")
    country: str = Field(None, description="Country where the individual resides.")
...
class ObjectiveSummary(BaseModel):
    ...
    objective: str = Field(None, description="The individual's career objective or goal.")
    career_summary: str = Field(None, description="A brief summary of the individual's career path.")
...
class JobPosition(BaseModel):
    ...
    company_name: str = Field(None, description="The name of the company where the individual worked.")
    job_title: str = Field(None, description="The job title held by the individual.")
    start_date: str = Field(None, description="The start date of the job (YYYY-MM-DD).")
    end_date: str = Field(None, description="The end date of the job or 'current' if still employed (YYYY-MM-DD).")
    job_location: str = Field(None, description="The location of the job.")
    job_description: List[str] = Field(None, description="A list of responsibilities and duties of the job.")
    achievements: List[str] = Field(None, description="Key achievements and contributions made in the role.")

class ProfessionalExperience(BaseModel):
    """Represents the individual's professional work experience."""
    work_experience: List[JobPosition] = Field(None, description="A list of jobs and relevant professional experience.")
...
class Education(BaseModel):
    ...
    education: List[EducationDetail] = Field(None, description="A list of the individual's educational qualifications.")

# 5. Skills
class Skills(BaseModel):
    """Represents the technical and soft skills possessed by the individual."""
    technical_skills: List[str] = Field(None, description="A list of the individual's technical skills.")
...
class CertificationsAndCourses(BaseModel):
    ...
    certifications: List[Certification] = Field(None, description="A list of professional certifications earned by the individual.")
    courses: List[Course] = Field(None, description="A list of additional courses completed by the individual.")
...
class Project(BaseModel):
    ...
    technologies_used: List[str] = Field(None, description="Technologies and tools used in the project.")
...
class Projects(BaseModel):
    ...
    projects: List[Project] = Field(None, description="A list of projects undertaken by the individual.")
...
class AwardsAndAchievements(BaseModel):
    ...
    awards_and_achievements: List[Award] = Field(None, description="A list of awards and achievements earned by the individual.")
...
class PublicationsAndResearch(BaseModel):
    ...
    publications: List[Publication] = Field(None, description="A list of publications authored by the individual.")
    research: List[Research] = Field(None, description="A list of research projects conducted by the individual.")
...
class Volunteering(BaseModel):
    ...
    volunteer_experience: List[VolunteerExperience] = Field(None, description="A list of volunteer experiences undertaken by the individual.")

# 11. Hobbies and Interests (optional)
class HobbiesInterests(BaseModel):
    """Represents the individual's hobbies and interests."""
    hobbies: List[str] = Field(None, description="A list of the individual's hobbies.")
    interests: List[str] = Field(None, description="A list of the individual's personal interests.")
...
class References(BaseModel):
    ...
    references: List[Reference] = Field(None, description="A list of professional references provided by the individual.")
...
class CV(BaseModel):
    ...
    personal_information: PersonalInformation = Field(None, description="Personal details of the individual.")
    objective_summary: ObjectiveSummary = Field(None, description="The individual's career objective or summary.")
    professional_experience: ProfessionalExperience = Field(None, description="Details of the individual's professional work experience.")
    education: Education = Field(None, description="The individual's educational background.")
    skills: Skills = Field(None, description="A list of technical and soft skills possessed by the individual.")
    certifications_and_courses: CertificationsAndCourses = Field(None, description="Certifications and courses completed by the individual.")
    projects: Projects = Field(None, description="Details about projects the individual has worked on.")
    awards_and_achievements: AwardsAndAchievements = Field(None, description="A list of awards and achievements earned by the individual.")
    publications_and_research: PublicationsAndResearch = Field(None, description="Details about publications and research projects by the individual.")
    volunteering: Volunteering = Field(None, description="A list of volunteer experiences.")
